 ...
 */
- (NSURLSessionDataTask *)muteWithInstanceID:(NSString *)instanceId channel:(nullable NSString *)channel completion:(nullable UPPResponseBlock)completion;
 ...
 */
- (NSURLSessionDataTask *)setMute:(BOOL)mute withInstanceID:(NSString *)instanceId channel:(nullable NSString *)channel success:(nullable UPPSuccessBlock)success;
...
/**
 ...
 @param completion A completion block which returns the parsed response, or an
 */
- (NSURLSessionDataTask *)volumeWithInstanceID:(NSString *)instanceId channel:(nullable NSString *)channel completion:(nullable UPPResponseBlock)completion;
 ...
 */
- (NSURLSessionDataTask *)setVolume:(NSNumber *)volume withInstanceID:(NSString *)instanceId channel:(nullable NSString *)channel success:(nullable UPPSuccessBlock)success;
